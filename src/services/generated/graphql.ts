...
export type GetAllProductsVariables = Exact<{
  pageSize?: InputMaybe<Scalars['Int']['input']>;
}>;


export type GetAllProducts = { __typename?: 'Query', products?: { __typename?: 'ProductEntityResponseCollection', data: Array<{ __typename?: 'ProductEntity', id?: string | null, attributes?: { __typename?: 'Product', name?: string | null, description?: string | null, isAvailable?: boolean | null, slug?: string | null, badge?: string | null, price?: Array<{ __typename?: 'ComponentEcommercePrices', id: string, badge?: string | null, isDiscounted: boolean, discounted_amount?: number | null, amount?: number | null, discount_percentage?: number | null } | null> | null, in_stock?: { __typename?: 'ComponentEcommerceStock', id: string, total?: number | null, delivering?: number | null, sold?: number | null, gifted?: number | null, available?: number | null } | null } | null }>, meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number, page: number, pageSize: number } } } | null };


export const GetAllProductsDocument = `
    query getAllProducts($pageSize: Int = 100) {
...
export const useGetAllProducts = <
      TData = GetAllProducts,
      TError = unknown
    >(
      client: GraphQLClient,
      variables?: GetAllProductsVariables,
      options?: UseQueryOptions<GetAllProducts, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<GetAllProducts, TError, TData>(
      variables === undefined ? ['getAllProducts'] : ['getAllProducts', variables],
      fetcher<GetAllProducts, GetAllProductsVariables>(client, GetAllProductsDocument, variables, headers),
      options
    );

useGetAllProducts.getKey = (variables?: GetAllProductsVariables) => variables === undefined ? ['getAllProducts'] : ['getAllProducts', variables];
;

export const useInfiniteGetAllProducts = <
      TData = GetAllProducts,
      TError = unknown
    >(
      pageParamKey: keyof GetAllProductsVariables,
      client: GraphQLClient,
      variables?: GetAllProductsVariables,
      options?: UseInfiniteQueryOptions<GetAllProducts, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useInfiniteQuery<GetAllProducts, TError, TData>(
      variables === undefined ? ['getAllProducts.infinite'] : ['getAllProducts.infinite', variables],
      (metaData) => fetcher<GetAllProducts, GetAllProductsVariables>(client, GetAllProductsDocument, {...variables, ...(metaData.pageParam ?? {})}, headers)(),
      options
    );


useInfiniteGetAllProducts.getKey = (variables?: GetAllProductsVariables) => variables === undefined ? ['getAllProducts.infinite'] : ['getAllProducts.infinite', variables];
;

useGetAllProducts.fetcher = (client: GraphQLClient, variables?: GetAllProductsVariables, headers?: RequestInit['headers']) => fetcher<GetAllProducts, GetAllProductsVariables>(client, GetAllProductsDocument, variables, headers);